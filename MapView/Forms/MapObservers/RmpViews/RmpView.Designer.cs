namespace MapView.Forms.MapObservers.RmpViews
{
	partial class RmpView
	{
		...
		private void InitializeComponent()
		{
			...
			this.HeightDifTextbox.ToolTipText = "This amount will be added to the link\'s vertical position. Helps"
												+ " in UFO maps when the UFO terrain maps have basement floors.";
