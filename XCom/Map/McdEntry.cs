...
namespace XCom
{
	...
	public class McdEntry : TileInfo
	{
		private byte[] info;
		...
		public bool UFODoor { get { return info[30] == 1; } }//				If it's a UFO door it uses only Frame[0] until it is walked through, then it animates once and becomes Alt_MCD.  It changes back at the end of the turn
		...
		public bool HumanDoor { get { return info[35] == 1; } }//			unsigned char Door;      //It's a human style door--you walk through it and it changes to Alt_MCD - does not change back at end of turn
		...
		public sbyte StandOffset { get { return (sbyte)info[48]; } }//	signed char T_Level;      //When a unit or object is standing on the tile, the unit is shifted by this amount
		public sbyte TileOffset { get { return (sbyte)info[49]; } }//		unsigned char P_Level;      //When the tile is drawn, this amount is subtracted from its y (so y position-P_Level is where it's drawn)
		...
		public SpecialType SpecialType { get { return (SpecialType)(sbyte)info[59]; } }//		unsigned char Target_Type;       //The special properties of the tile
